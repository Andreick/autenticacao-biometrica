 ...
 */
public class FingerprintProcessorJava {

    private static final String TAG = "FingerprintProcessJava";

    private final Mat MatSnapShot;
    private final Mat MatSnapShotMask;

    public FingerprintProcessorJava(Mat matSnapShot, Mat matSnapShotMask) {
        this.MatSnapShot = matSnapShot;
        this.MatSnapShotMask = matSnapShotMask;
    }
